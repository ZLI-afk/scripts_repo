...
def elastic(strategy_list):
    ...
    for strategy in strategy_list:
        ...
        os.chdir(strategy)
        result_txt.append('\n')
    out_file = os.path.join(out_path, 'elastic.txt')
...
def relax(strategy_list):
    ...
    for strategy in strategy_list:
        ...
        os.chdir(strategy)
        result_txt.append('\n')
    out_file = os.path.join(out_path, 'relaxation.txt')
    print(f'writing to {out_file}...')
    with open(out_file, 'w') as f:
        for ii in range(len(result_txt)):
            f.write(result_txt[ii])
...
def vacancy(strategy_list):
    ...
    for strategy in strategy_list:
        ...
        os.chdir(strategy)
        result_txt.append('\n')
    out_file = os.path.join(out_path, 'vacancy.txt')
    print(f'writing to {out_file}...')
    with open(out_file, 'w') as f:
        for ii in range(len(result_txt)):
            f.write(result_txt[ii])
...
def interstitial(strategy_list):
    ...
    for strategy in strategy_list:
        ...
        os.chdir(strategy)
        result_txt.append('\n')
    out_file = os.path.join(out_path, 'interstitial.txt')
    print(f'writing to {out_file}...')
    with open(out_file, 'w') as f:
        for ii in range(len(result_txt)):
            f.write(result_txt[ii])
...
def surface(strategy_list):
    ...
    for strategy in strategy_list:
        ...
        os.chdir(strategy)
        result_txt.append('\n')
    out_file = os.path.join(out_path, 'surface.txt')
    print(f'writing to {out_file}...')
    with open(out_file, 'w') as f:
        for ii in range(len(result_txt)):
            f.write(result_txt[ii])
...
def eos(strategy_list):
    ...
    for strategy in strategy_list:
        ...
        #os.chdir(strategy)
    out_file = os.path.join(out_path, 'eos.txt')
    print(f'writing to {out_file}...')
    with open(out_file, 'w') as f:
        for ii in range(len(result_txt)):
            f.write(result_txt[ii])
...
def cohesive(strategy_list):
    ...
    for strategy in strategy_list:
        ...
        #os.chdir(strategy)
    out_file = os.path.join(out_path, 'cohesive.txt')
    print(f'writing to {out_file}...')
    with open(out_file, 'w') as f:
        for ii in range(len(result_txt)):
            f.write(result_txt[ii])
...
def gamma(strategy_list, type):
    ...
    for strategy in strategy_list:
        ...
        # os.chdir(strategy)
    out_file = os.path.join(out_path, f'{type}.txt')
    print(f'writing to {out_file}...')
    with open(out_file, 'w') as f:
        for ii in range(len(result_txt)):
            f.write(result_txt[ii])
